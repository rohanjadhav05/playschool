...
const INITIAL = { parentName: '', childName: '', childAge: '', program: 'playschool', phone: '', message: '' }
...
export default function ContactForm() {
  ...
  const handleSubmit = (e) => {
    ...
    const msg = [
      ...
      `I am interested in ${programLabel[form.program]} for my child ${form.childName} (age ${form.childAge || 'not specified'}).`,
    ...
    const waUrl = `https://wa.me/${SCHOOL.whatsapp}?text=${encodeURIComponent(msg)}`
        ...
        {submitted ? (
          ...
          >
            ...
            <p className="font-body text-textSecondary text-sm mb-6">
              WhatsApp has been opened with your details. We'll be in touch soon!
            </p>
            <button
          ...
          <motion.form
            ...
            noValidate
          >
            <h3 className="font-display font-bold text-xl text-textPrimary mb-6">
